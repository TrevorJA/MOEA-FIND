...
:mod:`src.pywrdrb.satisficing_metrics`) and a manifest of candidate satisficing
...
def sweep_manifest(
    ...
    Args:
        bank_df: Metric bank from :func:`src.pywrdrb.satisficing_metrics.compute_metric_bank`.
        ...
        feature_cols: Drought-characteristic columns in *chars_df* used as
            ...
            metric preset defined in :mod:`src.metrics.drought_metrics`.
