...
Run (SLURM only, not login-node):
    sbatch workflows/slurm/diag_kirsch_wrapper_geometry.slurm
"""
...
def _build_kirsch_generator(monthly_2d: np.ndarray):
    ...
    Mirrors the helper in workflows/experiments/13_dv_uniformity_ablation.py
    lines 60-74.
    """
    import pandas as pd
...
def main():
    ...
    # ---- Fit KirschGenerator ----
    gen = _build_kirsch_generator(monthly_2d)
