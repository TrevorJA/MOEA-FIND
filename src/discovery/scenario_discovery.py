...
def plot_satisficing_map_multi(
    ...
    Args:
        labels_long: Output of
            :func:`src.discovery.satisficing_labels.apply_labels(bank_df, manifest)`.
        ...
        chars_df: Drought-characteristic features indexed by
            ...
            *feature_cols*.
        manifest: Sequence of :class:`~src.discovery.satisficing_labels.SatisficingDefinition`.
        classifiers_dir: Directory holding one subdir per definition
            (``<definition_id>/model.joblib``) as written by
            :func:`src.discovery.satisficing_labels.sweep_manifest`.
